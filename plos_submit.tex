...
For example, Table~(\nameref{S8_Table}) shows how five entries of \codewhite{STATE-COUNTY RECODE} corresponding to counties within New Mexico can be represented by the 
...
to the conditions in Table~(\nameref{S10_Table}) and Table~(\nameref{S11_Table}), respectively.
